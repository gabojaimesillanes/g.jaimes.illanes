...
<h3>Classification Results Plots ALL</h3>
<embed src="./pdf/classification_results_plots_ALL.pdf" width="600" height="400" type="application/pdf">

<h3>Classification Results Plots</h3>
<embed src="./pdf/classification_results_plots.pdf" width="600" height="400" type="application/pdf">
...
### Step 12: Retrieving, Filtering, and Visualizing of (x1)Classification | ALFALFA
